...
\begin{center}
\leavevmode
\includegraphics[width=265pt]{classMediaStreamHandler__coll__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{classMediaStreamHandler_a4c7b9de79b65783f347e634724253988}{Send\+Fragmented\+RTPPackets}} (unsigned char $\ast$payload, size\+\_\+t payload\+Size, \mbox{\hyperlink{classRTPPacket}{RTPPacket}} \&rtp\+Packet)
\begin{DoxyCompactList}\small\item\em 오디오 스트림을 처리하는 메서드 \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classMediaStreamHandler_a596c40ab0acc1c1a0f0d10edcaef7542}{Send\+RTCPPacket}} (\mbox{\hyperlink{classRTCPPacket}{RTCPPacket}} \&rtcp\+Packet)
...
미디어 스트림의 상태 관리, RTP 패킷 생성 및 전송, 스트리밍 제어 기능을 제공하는 클래스 \begin{DoxySeeAlso}{See also}
\mbox{\hyperlink{classUDPHandler}{UDPHandler}} 

\mbox{\hyperlink{classRTPPacket}{RTPPacket}} 

\mbox{\hyperlink{classRTCPPacket}{RTCPPacket}} 
\end{DoxySeeAlso}
...
\end{DoxyItemize}\mbox{\Hypertarget{classMediaStreamHandler_a4c7b9de79b65783f347e634724253988}\label{classMediaStreamHandler_a4c7b9de79b65783f347e634724253988}} 
...
{\footnotesize\ttfamily void Media\+Stream\+Handler\+::\+Send\+Fragmented\+RTPPackets (\begin{DoxyParamCaption}\item[{unsigned char $\ast$}]{payload,  }\item[{size\+\_\+t}]{payload\+Size,  }\item[{\mbox{\hyperlink{classRTPPacket}{RTPPacket}} \&}]{rtp\+Packet }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\end{DoxyItemize}\mbox{\Hypertarget{classMediaStreamHandler_a596c40ab0acc1c1a0f0d10edcaef7542}\label{classMediaStreamHandler_a596c40ab0acc1c1a0f0d10edcaef7542}} 
\index{MediaStreamHandler@{MediaStreamHandler}!SendRTCPPacket@{SendRTCPPacket}}
\index{SendRTCPPacket@{SendRTCPPacket}!MediaStreamHandler@{MediaStreamHandler}}
\doxysubsubsection{\texorpdfstring{SendRTCPPacket()}{SendRTCPPacket()}}
{\footnotesize\ttfamily void Media\+Stream\+Handler\+::\+Send\+RTCPPacket (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classRTCPPacket}{RTCPPacket}} \&}]{rtcp\+Packet }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\begin{DoxyParams}{Parameters}
{\em rtcp\+Packet} & RTCP 패킷 객체\\
\hline
{\em rtcp\+Packet} & 전송할 RTCP 패킷 객체\\
\hline
\end{DoxyParams}
RTCP 패킷을 생성하고 전송 \mbox{\Hypertarget{classMediaStreamHandler_a848698e610bdf4f4890796f0bbece756}\label{classMediaStreamHandler_a848698e610bdf4f4890796f0bbece756}} 
